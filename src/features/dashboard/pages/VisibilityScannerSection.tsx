...
function WhatsNextCard({ data }: { data: ScannerData; treatment: Treatment }) {
  ...
  const items: {
  ...
  }[] = [
    {
      ...
      description: `Mark up your most-visited pages with FAQ structured data. Biggest lever for getting picked up by ${weakEngine.label}.`,
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[260px_minmax(0,1fr)_320px] gap-4 items-stretch">
        ...
        <ScrollReveal delay={0.1}>
          <WhatsNextCard data={data} treatment={treatment} />
        </ScrollReveal>
      </div>
