...
export const IconContainer = ({
  ...
  return (
    ...
    >
      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-slate-700 bg-slate-800 shadow-inner">
        {icon || (
          <svg className="h-10 w-10 text-slate-600" fill="currentColor" viewBox="0 0 20 20">
